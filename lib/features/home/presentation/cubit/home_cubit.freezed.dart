...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({DataStatus dataStatus, String? error, List<Todo> todoList});
}
...
class _$HomeStateImpl implements _HomeState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, dataStatus, error,
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      {final DataStatus dataStatus,
      final String? error,
      final List<Todo> todoList}) = _$HomeStateImpl;
